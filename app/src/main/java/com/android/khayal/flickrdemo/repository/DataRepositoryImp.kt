...
class DataRepositoryImp @Inject constructor(
    ...
    @Inject
    lateinit var searchResultsRateLimiter: RateLimiter<String>
        ...
        networkBoundResourceResultLiveData = object :
            ...
            override fun processResponse(response: ApiSuccessResponse<SearchResponse.Content>): SearchResponse.Content {
                response.body.items.forEach {
                    it.tagMode =
                        tagMode // as the tagMode is part of the request and not of result and will be used later in querying db
                }
